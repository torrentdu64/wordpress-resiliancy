...
if(a.slug_id!==h){var u=p.parentNode,v=b.create([{type:"radio",id:"term_type",label:b.label.query_by,"default":g.term_type===h&&"post_slug"===g[a.tax_id]?"post_slug":!1,option_js:!0,options:[{value:"all",name:b.label.all_posts},{value:"category",name:b.label.query_term_id},{value:"post_slug",name:b.label.slug_label}]}]),x=b.create([{id:a.slug_id,type:"text","class":"large",wrap_class:"tb_group_element_post_slug",help:b.label.slug_desc,label:b.label.slug_label}]);u.parentNode.insertBefore(v,u);u.parentNode.appendChild(x)}a.sticky_id!==
h&&(u=b.create([{type:"toggle_switch",label:b.label.sticky_first,id:a.sticky_id,options:"simple",wrap_class:"tb_group_element_all"}]),p.parentNode.parentNode.appendChild(u));r.addEventListener("change",function(a){t.triggerEvent(d,"queryPosts",{val:q})},{passive:!0});null!==w&&clearTimeout(w);w=setTimeout(function(){b.callbacks()},2)}p.getElementsByClassName("query_category_multiple")[0].value=q;!0===y||b.is_new?t.triggerEvent(d,"queryPosts",{val:q}):ThemifyConstructor.settings=m.Utils.clear(m.Forms.serialize("tb_options_setting"));
y=!0}};c.cacheTerms[k]===h?r(d.parentNode,k,"terms").done(function(a){c.cacheTerms[k]=a;p()}):p()},x=0,B=p.length;x<B;++x)if(q[p[x]]){q.id=q[p[x]];q.label=b.label["query_"+p[x]];q.type="selectSearch";"term_id"===p[x]?(q.wrap_class="tb_search_term_wrap tb_group_element_category",q["class"]="query_category_single",q.help=b.label.query_desc,q.control={control_type:"queryPosts"}):"tax_id"!==p[x]&&"tag_id"!==p[x]||q.term_id!==h||(q.control={control_type:"queryPosts"});delete q.description;delete q.after;
var z=b.create([q]);!0===a.just_current&&delete q.wrap_class;(function(){var b="id"===p[x],d="term_id"===p[x]||"tag_id"===p[x],e=d?"":g[q.id],f=z.querySelector(".tb_search_input");f.addEventListener("selectElement",function(e){e=e.detail.val;var f=this.closest(".tb_field");d?(f.getElementsByClassName("query_category_multiple")[0].value=e,t.triggerEvent(this,"queryPosts",{val:e})):null!==f.nextElementSibling?(f=f.nextElementSibling,b||!0!==y||a.slug_id===h||(f=f.nextElementSibling),null!==f&&(f=f.getElementsByClassName("tb_search_input")[0],
b?c.cacheTypes[e]!==h&&(!0===a.just_current&&"tag"===g[a.tax_id]&&(g[a.tax_id]="post_tag"),n(f,g[a.tax_id],k(c.cacheTypes[e].options)),t.triggerEvent(f,"selectElement",{val:f.getAttribute("data-value")})):C(f,e))):b||t.triggerEvent(this,"queryPosts",{val:this.getAttribute("data-value")})},{passive:!0});if(b){var l=function(){e||(e="post");n(f,e,k(c.cacheTypes));t.triggerEvent(f,"selectElement",{val:e});f=null};null===c.cacheTypes?r(f.parentNode,null,"post_types").done(function(b){c.cacheTypes=b;!0===
a.just_current&&h==e&&(e=Object.keys(b));l()}):setTimeout(l,10)}else d&&!a.id&&a.taxonomy!==h&&C(f,a.taxonomy)})();u.appendChild(z)}d.parentNode.replaceChild(u,d);q=d=null})})();return d}},position_box:{w:null,h:null,update:function(a,b,c){c=z.Lightbox.$lightbox[0].querySelector("#"+a);null===c&&(c=z.Lightbox.$lightbox[0].querySelector('[data-input-id="'+a+'"]'));if(null!==c){var d=c.closest(".tb_position_box_wrapper");a=d.getElementsByClassName("tb_position_box_handle")[0];var d=d.getElementsByClassName("tb_position_box_label")[0],
f=this.getPreDefinedPositions();b?f[b]!==h&&(b=f[b]):b="50,50";c.value=b;d.textContent=this.getLabel(b);b=b.split(",");a.style.left=Math.ceil(b[0]*this.w/100)+"px";a.style.top=Math.ceil(b[1]*this.h/100)+"px"}},getLabel:function(a){switch(a){case "0,0":a="Top Left";break;case "50,0":a="Top Center";break;case "100,0":a="Top Right";break;case "0,50":a="Center Left";break;case "50,50":a="Center Center";break;case "100,50":a="Center Right";break;case "0,100":a="Bottom Left";break;case "50,100":a="Bottom Center";
break;case "100,100":a="Bottom Right";break;default:a=a.split(","),a=""===a[0]?"Center Center":"X:"+a[0]+"% Y:"+a[1]+"%"}return a},getPreDefinedPositions:function(){return{"right-top":"100,0","right-center":"100,50","right-bottom":"100,100","left-top":"0,0","left-center":"0,50","left-bottom":"0,100","center-top":"50,0","center-center":"50,50","center-bottom":"50,100"}},click:function(a){a.preventDefault();a.stopPropagation();var b=a.currentTarget.previousElementSibling;if(a.target.classList.contains("tb_position_item")){a=
a.target.getAttribute("data-pos").split(",");var c=a[0];a=a[1];"50"===c?c=this.w/2:"100"===c&&(c=this.w);"50"===a?a=this.h/2:"100"===a&&(a=this.h)}else c=a.offsetX,a=a.offsetY;b.style.left=c+"px";b.style.top=a+"px";this.changeUpdate(b,c,a)},changeUpdate:function(a,b,c){b=+(b/this.w*100).toFixed(2);c=+(c/this.h*100).toFixed(2);a=a.closest(".tb_position_box_wrapper").getElementsByClassName("tb_position_box_label")[0];var d=a.nextElementSibling;d.value=b+","+c;a.textContent=this.getLabel(b+","+c);t.triggerEvent(d,
"change")},render:function(a,b){var c=this,d=this.getPreDefinedPositions(),f=b.getStyleVal(a.id),e=l.createElement("div"),g=l.createElement("div"),k=l.createElement("div"),n=l.createElement("div"),r=l.createElement("div"),m=b.hidden.render(a,b);e.className="tb_position_box_wrapper";g.className="tb_position_box_container";k.className="tb_position_box";n.className="tb_position_box_handle";r.className="tb_position_box_label";for(var w in d){var t=l.createElement("div"),v=l.createElement("span"),y=l.createElement("span"),
C=d[w].split(",");v.className="themify_tooltip";y.textContent=w.replace("-"," ");t.className="tb_position_item";t.setAttribute("data-pos",d[w]);t.style.left=C[0]+"%";t.style.top=C[1]+"%";v.appendChild(y);t.appendChild(v);k.appendChild(t)}k.addEventListener("click",this.click.bind(this));g.appendChild(n);g.appendChild(k);e.appendChild(g);a.after!==h&&e.appendChild(b.after(a));e.appendChild(r);e.appendChild(m);var x=function(d){var e=p(k);c.w=e.outerWidth();c.h=e.outerHeight();e=k=null;c.update(a.id,
f,b);var g=null;q.jQuery.fn.draggable.call(p(d),{containment:"parent",scroll:!1,drag:function(a,b){null!==g&&clearTimeout(g);g=setTimeout(function(){c.changeUpdate(b.helper[0],b.position.left,b.position.top);clearTimeout(g);g=null},10)},stop:function(a,b){c.changeUpdate(b.helper[0],b.position.left,b.position.top);null!==g&&(clearTimeout(g),g=null)}})};q.jQuery.fn.draggable===h?b.afterRun.push(function(a){q.Themify.LoadAsync(themifyBuilder.includes_url+"js/jquery/ui/draggable.min.js",function(a){x(a)}.bind(null,
a),tbLocalScript.version,null,function(){return q.jQuery.fn.draggable!==h})}.bind(null,n)):b.afterRun.push(function(a){x(a)}.bind(null,n));return e}},slider_range:{render:function(a,b){var c=l.createElement("div"),d=l.createElement("div"),f=b.hidden.render(a,b),e=0,g=100,k="%",n=!0,r=1;a.options!==h&&(a.options.min!==h&&(e=a.options.min),a.options.max!==h&&(g=a.options.max),a.options.unit!==h&&(k=a.options.unit),a.options.range!==h&&(n=!1),a.options["default"]!==h&&(r=a.options["default"]));f.setAttribute("data-min",
e);f.setAttribute("data-max",g);f.setAttribute("data-unit",k);e=g=k=null;c.className="tb_slider_wrapper input-range";d.className="range-slider";a.wrap_class!==h&&(c.className=" "+a.wrap_class);c.appendChild(d);c.appendChild(f);var m=function(a){var b=l.createElement("span"),c=l.createElement("span"),d=parseFloat(f.getAttribute("data-min")),e=parseFloat(f.getAttribute("data-max")),g=f.getAttribute("data-unit"),k=f.value,k=n?k?k.split(","):[d,e]:k?k:r;b.className="tb_slider_label_l";c.className="tb_slider_label_u";
d={range:n,min:d,max:e,slide:function(a,d){n?(b.textContent=d.values[0]+g,c.textContent=d.values[1]+g):b.textContent=d.value+g},create:function(a,d){var e=this.getElementsByClassName("ui-slider-handle");n?(b.textContent=k[0]+g,e[0].appendChild(b),c.textContent=k[1]+g,e[1].appendChild(c)):(b.textContent=k+g,e[0].appendChild(b));k=null},change:function(a,b){f.value=n?b.values[0]+","+b.values[1]:b.value}};n?d.values=k:d.value=k;q.jQuery.fn.slider.call(p(a),d)};q.jQuery.fn.slider===h?b.afterRun.push(function(a){q.Themify.LoadAsync(themifyBuilder.includes_url+
